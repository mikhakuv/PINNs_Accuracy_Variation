...
В приведённой ниже таблице рассчитано, во сколько раз увеличивается максимальное значение модуля каждого из слагаемых при $t=0$(при других $t$ картина похожая):  
