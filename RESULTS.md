...
Этот момент уточнён для того, чтобы обосновать изучение производных действительной и мнимой частей функции по отдельности, ведь при оптимизации они находятся отдельно. На графике 6 видно, как увеличиваются все слагаемые обоих минимизируемых выражений $Re(F)$ и $Im(F)$ при росте $\mu$ при $t=0$:  
