...
\end{table}
-->
Нелинейность уравнения также растёт, поэтому с ростом $\mu$ решение всё сильнее отличается от решения линейного уравнения и всё сложнее найти его. Если $alpha>0$, то рост нелинейности с увеличением $\mu$ будет более существенным и поэтому зависимость точности решения от $\mu$ по идее будет более сильной.  
